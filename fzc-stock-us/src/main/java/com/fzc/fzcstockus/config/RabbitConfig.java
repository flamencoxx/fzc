package com.fzc.fzcstockus.config;
...
public class RabbitConfig {
    ...
    /**
     * Direct Exchange BasicFinancial
     */
    public static class DirectExchangeDemoConfiguration {

        // 创建 Queue
        @Bean
        public Queue BasicFinancialQueue() {
            return new Queue(BasicFinancialMessage.QUEUE, // Queue 名字
                    true, // durable: 是否持久化
        ...
        // 创建 Direct Exchange
        @Bean
        public DirectExchange BasicFinancialExchange() {
            return new DirectExchange(BasicFinancialMessage.EXCHANGE,
                    true,  // durable: 是否持久化
                    false);  // exclusive: 是否排它
        }
        ...
        @Bean
        public Binding BasicFinancialBinding() {
            return BindingBuilder.bind(BasicFinancialQueue()).to(BasicFinancialExchange()).with(BasicFinancialMessage.ROUTING_KEY);
        }
